...
<head>
<title>Cloud User Profile</title>
    ...
    <div class="content_resize">
      <div class="mainbar">
		...
		<%				 String dname=request.getParameter("dname");
            ...
            <p align="right"><a href="A_AllAttackers.jsp" class="style4">Back</a></p>
			<%}
            ...
            <p align="right"><a href="A_SDRequests.jsp" class="style4">Back</a></p>
			<%}
