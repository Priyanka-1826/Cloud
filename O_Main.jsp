...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <h2>Wel-Come Data Owner <%=(String)application.getAttribute("oname")%></h2>
        <p align="center"><img src="images/User.jpg" width="509" height="258" /></p>
        <p align="center">&nbsp;</p>
      </div>
      <div class="sidebar">
        <div class="clr"></div>
        <div class="gadget">
		  ...
		  <li><strong><a href="C_Main.jsp">Home</a></strong></li>
            <li><strong><a href="O_Profile.jsp">View Profile</a></strong></li>
			 <li><strong><a href="O_Upload.jsp">Upload Patient Data</a></strong></li>
			 <li><strong><a href="O_View_Uploaded_Files.jsp">View Uploaded Patient Data</a></strong></li>
			 <li><strong><a href="O_Verify_Uploaded_Files.jsp">Verify Uploaded Files</a></strong></li>
