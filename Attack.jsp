...
<table border="0" align="center">
	<tr>
		...
		<td>&nbsp;</td>
       	...
       	<tr>
		<td width="223" bgcolor="#FF0000"><span class="style1 style7 style4">Enter Patient Name :-</span></td>
		<td width="245"><label> <input required name="t1"
			type="text"  size="40" /> </label></td>
	</tr>
	<tr>
		<td bgcolor="#FF0000"><span class="style4"></span></td>
		<td>&nbsp;</td>
	</tr>

	<tr>
		<td bgcolor="#FF0000"><span class="style1 style7 style4">Your  Name  :-</span></td>
