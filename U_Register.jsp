  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
	    ...
	    <h2><span>USER REGISTERATION FORM  </span></h2>
	   
	   
	   <form action="U_RegIns.jsp" method="post" enctype="multipart/form-data" id="s" name="s" onsubmit="return valid()" ons target="_top">
            <ol class="style9">
              <li>
                <label for="name"><br />
                <img src="images/Register.jpg" width="181" height="133" /><br />
                <br />
                Name (required)</label>
            ...
            <ol class="style9">
              <li>
                ...
                <input  name="mobile" id="mobile" class="text" />
              </li>
            </ol>
            <ol class="style9">
              <li>
            ...
            <ol class="style9">
              <li>
                ...
                <input name="dob" id="dob" class="text" />
              </li>
            </ol>
            <ol class="style3">
          <li class="style9"> 
            <label for="label5">Gender (required)</label>
              ...
              <li class="style9">
                <select name="gender" id="gender" style="width:480px;" class="text">
           ...
           <li>
                ...
                </span><span class="style5"><strong><label for="pic"></label>
              </strong></span><span class="style4"><strong><label for="pic"></label>
              </strong></span><strong><label for="pic"></label>
                </strong>
