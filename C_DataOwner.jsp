    ...
    <div class="content_resize">
      <div class="mainbar">
		...
		<%				 String dname=request.getParameter("dname");
			...
			<%}
			else if(type.equalsIgnoreCase("alldoc")){%>
            <p align="right"><a href="A_DocDetail.jsp?id=<%=id%>&dname=<%=dname%>&type=<%=type%>" class="style4">Back</a></p>
			<%}
			else if(type.equalsIgnoreCase("user2")){%>
            <p align="right"><a href="A_UserSecretKeyReq.jsp" class="style4">Back</a></p>
			<%}
			else if(type.equalsIgnoreCase("user3")){%>
            <p align="right"><a href="A_UserAccessReq.jsp" class="style4">Back</a></p>
			<%}
			else if(type.equalsIgnoreCase("user4")){%>
            <p align="right"><a href="A_UploadRequest.jsp" class="style4">Back</a></p>
			<%}
			else if(type.equalsIgnoreCase("user5")){%>
            <p align="right"><a href="A_AllDownloadHistory.jsp" class="style4">Back</a></p>
			<%}
            ...
            <p align="right"><a href="A_DocDetail.jsp?id=<%=id%>&dname=<%=dname%>&type=<%=type%>" class="style4">Back</a></p>
			<%}
			else if(type.equalsIgnoreCase("accessreq")){%>
            <p align="right"><a href="A_DocDetail.jsp?id=<%=id%>&dname=<%=dname%>&type=<%=type%>" class="style4">Back</a></p>
			<%}
      ...
      <div class="sidebar">
        ...
        <div class="gadget">
          ...
          <div class="clr"></div>
          <ul class="sb_menu">
            <li><a href="C_Main.jsp">Cloud Home</a></li>
