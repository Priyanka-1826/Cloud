...
<head>
<title>User Data Owner Profile</title>
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
		 ...
		 <h2 class="style5">  <span class="style6">Data Owner <%=request.getParameter("oname")%></span>'s Profile</span>... </h2>
          <div class="clr"></div>
          <p>&nbsp;</p>
          <table width="533" border="1.5" align="center"  cellpadding="0" cellspacing="0"  >
            ...
            <%
						...
						String user=request.getParameter("oname");
            ...
            <tr>
              <td width="226" rowspan="6" ><div class="style7 style26" style="margin:10px 13px 10px 13px;" ><strong><a class="#" id="img1" href="#" >
                  <input  name="image" type="image" src="images.jsp?value=<%="owner"%>&id=<%=i%>" style="width:200px; height:200px;" />
              </a></strong></div></td>
            </tr>
            <tr>
		...
		<%				 String dname=request.getParameter("dname");
            ...
            <p align="right"><a href="U_OwnerDocs.jsp" class="style4">Back</a></p>
			<%}
			else if(type.equalsIgnoreCase("search")){%>
            <p align="right"><a href="U_DocDetails.jsp?id=<%=id%>&dname=<%=dname%>&rank=<%=rank%>&type=<%=type%>" class="style4">Back</a></p>
			<%}
			else if(type.equalsIgnoreCase("downloads")){%>
            <p align="right"><a href="U_AllMyDownloads.jsp" class="style4">Back</a></p>
			<%}
			else if(type.equalsIgnoreCase("secretkey")){%>
            <p align="right"><a href="U_AskSecretKey1.jsp" class="style4">Back</a></p>
			<%}
			else if(type.equalsIgnoreCase("accessper")){%>
            <p align="right"><a href="U_AskAccessPer1.jsp" class="style4">Back</a></p>
			<%}
			else if(type.equalsIgnoreCase("allpermitt")){%>
            <p align="right"><a href="U_DocDetails.jsp?id=<%=id%>&dname=<%=dname%>&rank=<%=rank%>&type=<%=type%>" class="style4">Back</a></p>
			<%}
			else if(type.equalsIgnoreCase("accessper1")){%>
            <p align="right"><a href="U_AllPermittedDocs.jsp" class="style4">Back</a></p>
			<%}
