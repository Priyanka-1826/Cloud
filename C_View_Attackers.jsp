...
<%@include file="connect.jsp" %>
  ...
  <tr>
   <td width="191" bgcolor="#FF0000"><div align="center" class="style2 style10 style1 style5 style6"><strong>Attacker Id</strong></div></td>
   <td width="150" height="30" bgcolor="#FF0000"><div align="center" class="style2 style10 style1 style5 style6"><strong>Attacker Name</strong></div></td>
     <td width="150" height="30" bgcolor="#FF0000"><div align="center" class="style2 style10 style1 style5 style6"><strong>Patient Name</strong></div></td>
	   <td width="150" height="30" bgcolor="#FF0000"><div align="center" class="style2 style10 style1 style5 style6"><strong>Secret Key Used</strong></div></td>
	     <td width="150" height="30" bgcolor="#FF0000"><div align="center" class="style2 style10 style1 style5 style6"><strong>Attacker Type</strong></div></td>
    <td width="139" bgcolor="#FF0000"><div align="center" class="style2 style10 style1 style5 style6"><strong>Attacked Date and Time</strong></div></td>
...
String onname=(String)application.getAttribute("owner");
  ...
  <tr>
    <td height="52"><div align="center" class="style7 style11"><strong><%=i%></strong></div></td>
    <td><div align="center" class="style7 style11"><strong><%=s2%></strong></div></td>
