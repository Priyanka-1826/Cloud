...
<head>
<title>User Register Inset</title>
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
		...
		<h2>User Register Data Insert</h2>
		...
		<%
					...
					if ( rs1.next() )
					   {
					   		%><h3 class="style3">User Name Already Exist</h3>
					   ...
					   {
					   String str="waiting";
						PreparedStatement ps=connection.prepareStatement("insert into user(name,pass,email,mobile,addr,dob,gender,image,status) values(?,?,?,?,?,?,?,?,?)");
						...
						if(x>0){
							...
							%><h3 class="style4"> Registered Successfully</h3>
      ...
      <div class="sidebar">
        ...
        <div class="gadget">
          ...
          <ul class="sb_menu">
            ...
            <li><a href="U_Login.jsp">Login</a></li>
          </ul>
        </div>
      </div>
      <div class="clr"></div>
