    ...
    <div class="content_resize">
      <div class="mainbar">
         <h2><span>Cloud LOGIN </span></h2>
          <div class="clr"></div>
 <form action="Authentication.jsp?value=<%="cloudlogin"%>" method="post" name="s" id="sendemail" onsubmit="return valid()" ons target="_top">
         	
            <ol class="style3">
              <li class="style5">
                <label for="name"><br />
                <img src="images/Login.png" width="178" height="78" /><br />
                <br />
                <br />
                Authority Name (required)</label>
