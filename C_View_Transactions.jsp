...
<head>
<title>C_View_Transactions</title>
...
<%@include file="connect.jsp" %>
  ...
  <tr>
   <td width="191" bgcolor="#FF0000"><div align="center" class="style2 style10 style1 style5 style6"><strong>Transaction Id</strong></div></td>
   <td width="150" height="30" bgcolor="#FF0000"><div align="center" class="style2 style10 style1 style5 style6"><strong>User Name</strong></div></td>
     <td width="150" height="30" bgcolor="#FF0000"><div align="center" class="style2 style10 style1 style5 style6"><strong>Patient Name</strong></div></td>
	   <td width="150" height="30" bgcolor="#FF0000"><div align="center" class="style2 style10 style1 style5 style6"><strong>Secret Key Used</strong></div></td>
	     <td width="150" height="30" bgcolor="#FF0000"><div align="center" class="style2 style10 style1 style5 style6"><strong>Task</strong></div></td>
    <td width="139" bgcolor="#FF0000"><div align="center" class="style2 style10 style1 style5 style6"><strong>Transaction Date and Time</strong></div></td>
