  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
		...
		<h2>Wel-Come User <%=(String)application.getAttribute("uname")%></h2>
		<p>
		  <%application.removeAttribute("msg");%>
		</p>
		<p align="center"><img src="images/UserBanner.jpg" width="648" height="251" /></p>
	  </div>
      <div class="sidebar">
        <div class="clr"></div>
        <div class="gadget">
          ...
          <ul class="sb_menu style3">
		   <li><a href="U_Main.jsp">Home</a></li>
			...
			<li><a href="U_Search_Data.jsp">Search Data</a></li>
			<li><a href="U_Download.jsp">Download Patient Report</a></li>
