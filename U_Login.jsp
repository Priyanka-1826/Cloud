    ...
    <div class="content_resize">
      <div class="mainbar">
         <h2><span>USER LOGIN </span></h2>
          <div class="clr"></div>
          <form action="Authentication.jsp?value=<%="userlogin"%>" name="s" method="post" id="valid" onsubmit="return valid()" ons target="_top" >
            <ol class="style3">
              <li>
                <label for="name"><br />
                <img src="images/Login.png" width="200" height="111" /><br />
                <br />
                <br />
                Name (required)</label>
              ...
              <li>
                ...
                <input name="pass" type="password" class="text" id="email" />
              </li>
            </ol>
            <p class="style3">&nbsp;</p>
            <p>
            ...
            <label>New User To Register <a href="U_Register.jsp">Click Here</a></label>
          </form>
